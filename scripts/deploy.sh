...
export BAND_RPC=laozi-testnet6.bandchain.org
export BAND_RPC_PORT=443
export BAND_RPC_BLOCK=https://rpc.laozi-testnet6.bandchain.org
export BAND_PROOF_URL=https://laozi-testnet6.bandchain.org/api/oracle/proof/
